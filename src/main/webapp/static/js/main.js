require.config(
  {
    ...
    paths: {
      ...
      'angular-resource': '/webjars/angularjs/1.2.12/angular-resource',
      'angular-route': '/webjars/angularjs/1.2.12/angular-route',
      'angular-cookies': '/webjars/angularjs/1.2.12/angular-cookies',
